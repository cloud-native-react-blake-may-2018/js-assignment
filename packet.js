...
// Do not use % operator.
function isEven(someNum) { //This would find powers of 2... and doesn't work anyway. 
    let n = someNum;
...
} //can I get (or can I build) a function that checks to see if something is a whole number? Can I round? Can I snip off decimals or non-decimals? 
...
function printShape(shape, height, character) {
    ...
    case 'Triangle': 
        ...
        break; 
    case 'Diamond':
        //verify that height is odd, with isEven funtion or at least % 2. 
        size = 1; 
        let amnt = 0; 
        while(size <= height) {
            amnt = (height - size) / 2
